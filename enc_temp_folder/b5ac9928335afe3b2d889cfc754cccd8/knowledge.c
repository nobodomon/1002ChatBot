...
* Input:
*	entity		- the entity
*	response	- the response for this entity
* 
* Returns:
*	node		- The linkedList node containing the entity and response
* 
*/
node_ptr create_node(const char* entity, const char* response) {
	node_ptr node = (node_ptr)malloc(sizeof(entRespNode));
...
*
*
* intent:		The intent of the statement.
* new_node:		The new node to be added to the linked list.
*/
